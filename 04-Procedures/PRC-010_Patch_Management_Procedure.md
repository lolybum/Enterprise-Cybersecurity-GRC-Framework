...
- Enterprise patch compliance assessments.
...
- Periodic patch management maturity assessments.
...
- Be approved by the Patch Management Manager.
...
- Annually.
- Following significant changes to enterprise patch management technologies.
- Following major cybersecurity incidents involving unpatched systems.
...
| Patch Management Manager | Approved |
...
| Review Cycle | Annual |
| Classification | Internal |
| Procedure Owner | Patch Management Manager |
| Status | Approved |
